...
const ProductEditScreen = () => {
	...
	const [photo1, setPhoto1] = useState('/Modezp-Shop-Frontend/images/plus.png');
	const [photo2, setPhoto2] = useState('/Modezp-Shop-Frontend/images/plus.png');
	const [photo3, setPhoto3] = useState('/Modezp-Shop-Frontend/images/plus.png');
	const [photo4, setPhoto4] = useState('/Modezp-Shop-Frontend/images/plus.png');
				...
				if (userLogin.userDetailsInfo.isAdmin) {
					if (!product.name || product._id !== productId) {
						...
						if (product.image[0]) {
							...
							setPhoto1('/Modezp-Shop-Frontend/images/plus.png');
						}
						if (product.image[1]) {
							setPhoto2(product.image[1]);
						} else {
							setPhoto2('/Modezp-Shop-Frontend/images/plus.png');
						}
						if (product.image[2]) {
							setPhoto3(product.image[2]);
						} else {
							setPhoto3('/Modezp-Shop-Frontend/images/plus.png');
						}
						if (product.image[3]) {
							setPhoto4(product.image[3]);
						} else {
							setPhoto4('/Modezp-Shop-Frontend/images/plus.png');
						}
					}
				}
			} else {
