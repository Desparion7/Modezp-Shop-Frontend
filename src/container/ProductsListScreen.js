...
const ProductsListScreen = () => {
	...
	useEffect(() => {
		...
		if (createSuccess) {
			navigate(`/Modezp-Shop-Frontend/admin/product/${createProdukt._id}/edit`);
		}
	}, [
		dispatch,
		navigate,
	...
	const searchHandler = () => {
		if (searchWord === '') {
			navigate(`/Modezp-Shop-Frontend/admin/productslist/page`);
		} else {
			navigate(`/Modezp-Shop-Frontend/admin/productslist/search/${searchWord}`);
		}
	};
									...
									<div className='productslist-body'>
										{products.map((product) => (
											<div className='productslist-body-user' key={product._id}>
												...
												<div className='productslist-body-text'>
													<Link to={`/Modezp-Shop-Frontend/admin/product/${product._id}/edit`}>
